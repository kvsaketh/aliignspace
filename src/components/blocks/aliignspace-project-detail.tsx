...
export function AliignspaceProjectDetail({
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-12 lg:gap-20">
            ...
            <motion.div
              ...
              className="h-fit"
            >
              <div className="bg-[#F6F5FB] rounded-2xl p-8 space-y-6">
      ...
      {/* Gallery */}
      <section ref={galleryRef} className="py-24 lg:py-32 bg-[#F6F5FB]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 30 }}
...
export default AliignspaceProjectDetail;

...
function CardIcon({ name }: { name?: string }) {
  if (name === "eye") {
    return (
      <svg className="w-8 h-8 text-[#7A22FF]" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
...
export function AliignspaceVisionMission({
  label = "Our Purpose",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <h3 className="font-serif text-2xl sm:text-3xl font-medium text-[#16141f] mb-4">
              {vision.title}
            </h3>
...
export default AliignspaceVisionMission;

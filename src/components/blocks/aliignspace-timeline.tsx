...
export function AliignspaceTimeline({
  label = "Our Journey",
  ...
  events = [
    {
      date: "2012",
      title: "The Beginning",
      description: "Aliignspace was founded in a small studio in Hyderabad with a bold vision to transform Indian interiors.",
    },
    {
      date: "2015",
    ...
    },
    {
      ...
      description: "Expanded to Mumbai and Delhi, completing 850+ homes and establishing Aliignspace as a national design leader.",
    },
  ],
}: Props) {
  ...
  return (
    <section ref={ref} className="py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: "#0B0B10" }}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-4xl mx-auto">
          {/* Vertical line */}
          <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-px md:-translate-x-px" style={{ backgroundColor: "rgba(198, 116, 243,0.2)" }} />
          ...
          <div className="space-y-12 md:space-y-16">
            {events.map((event, i) => {
              ...
              return (
                ...
                >
                  {/* Dot on line */}
                  <div className="absolute left-4 md:left-1/2 top-1.5 md:top-1/2 w-3 h-3 rounded-full md:-translate-x-1/2 md:-translate-y-1/2" style={{ backgroundColor: "rgb(198, 116, 243)" }}>
                    <div className="absolute inset-0 rounded-full animate-ping opacity-30" style={{ backgroundColor: "rgb(198, 116, 243)" }} />
                  </div>

                  {/* Content */}
                  <div className={`ml-12 md:ml-0 md:w-1/2 ${isLeft ? "md:pr-16 md:text-right" : "md:pl-16 md:text-left"}`}>
                    <span className="font-serif text-2xl sm:text-3xl font-medium" style={{ color: "rgb(198, 116, 243)" }}>
                      {event.date}
                    </span>
...
export default AliignspaceTimeline;

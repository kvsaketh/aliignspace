...
export function AliignspaceStory({
  label = "How We Began",
  title = "A journey built on passion and",
  accentWord = "purpose",
  body = [
    "Aliignspace was born from a simple observation: most people settle for spaces that don't inspire them. In 2012, our founders—a duo of architects with a shared vision—decided to change that narrative.",
  ...
  return (
    <section ref={ref} className="py-24 lg:py-32 overflow-hidden" style={{ backgroundColor: "#F6F5FB" }}>
...
export default AliignspaceStory;

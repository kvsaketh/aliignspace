...
export function AliignspaceFounders({
  label = "Leadership",
  ...
  founders = [
    ...
    },
    {
      ...
      bio: "Priya's background in fine arts and sustainable design shapes Aliignspace's commitment to eco-conscious interiors. She believes that beauty and responsibility can coexist in every space we create.",
      linkedIn: "#",
    },
  ],
}: Props) {
...
export default AliignspaceFounders;

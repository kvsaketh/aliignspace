...
export function AliignspaceWhoWeAre({
  label = "Who We Are",
  title = "Designing spaces that reflect",
  accentWord = "you",
  body = [
    "At Aliignspace, we don't just design interiors—we curate experiences. Every project begins with listening, understanding, and imagining what a space could become when it truly belongs to the people who live in it.",
              ...
              {stats.map((stat, i) => (
                <div key={i}>
                  <div className="font-serif text-3xl sm:text-4xl font-medium text-[#16141f]">
                    {stat.number}
                    <span className="text-[#6D28D9]">{stat.suffix}</span>
                  </div>
...
export default AliignspaceWhoWeAre;

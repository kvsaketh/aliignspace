...
export function AliignspaceProcessWheel({
  title = "Our Process",
  subtitle,
  steps = [],
}: Props) {
    ...
    <section className="py-20 lg:py-28 bg-[#16141f]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 lg:mb-16">
          {subtitle && (
            <span className="block font-sans text-[11px] uppercase tracking-[0.25em] text-[#C4A2FF] mb-3">
              {subtitle}
            </span>
          )}
...
export default AliignspaceProcessWheel;

...
const defaultVideos: Video[] = [
  {
    ...
    quote: "Aliignspace turned our vision into a breathtaking reality.",
  },
  {
...
export function AliignspaceVideoTestimonials({
  label = "Video Stories",
  title = "Real Homes.",
  ...
  return (
    <section className="py-24 lg:py-32 bg-[#F6F5FB]" ref={ref}>

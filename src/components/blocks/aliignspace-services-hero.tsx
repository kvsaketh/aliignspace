...
export function AliignspaceServicesHero({
  eyebrow = "Our Services",
  title = "Design solutions for every",
  accentWord = "space",
  subtitle = "From concept to completion, we offer a full spectrum of interior design services tailored to your lifestyle, budget, and vision.",
}: Props) {
...
export default AliignspaceServicesHero;

    ...
    >
      ...
      <div className="absolute top-3 left-3 right-3 flex items-center justify-between gap-1">
        ...
        <div className="flex items-center gap-[2px] bg-black/50 backdrop-blur-sm px-1.5 py-0.5 rounded-full border border-white/10">
          {[...Array(s.rating ?? 5)].map((_, i) => (
            <Star key={i} className="w-[7px] h-[7px] text-[#f2a03c] fill-[#f2a03c]" />
          ))}
        </div>
      </div>
      ...
      {onPlay && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="relative">
            <div className="absolute -inset-3 rounded-full bg-[#8b5cd8]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
            <div className="relative w-11 h-11 rounded-full bg-white/20 backdrop-blur-md border border-white/30 flex items-center justify-center group-hover:bg-[#8b5cd8] group-hover:border-[#8b5cd8] transition-all duration-300 group-hover:scale-110">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-3.5">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-5 h-5 rounded-full bg-[#8b5cd8]/25 border border-[#8b5cd8]/40 flex items-center justify-center flex-shrink-0">
            <span className="font-sans text-[8px] font-bold text-[#c8a3f0]">{getInitials(s.name)}</span>
          </div>
          <p className="font-sans text-[10px] text-white/55 truncate leading-none">{s.name}</p>
        </div>
      </div>
      <div className="absolute inset-0 rounded-2xl ring-0 group-hover:ring-1 group-hover:ring-[#8b5cd8]/60 transition-all duration-300 pointer-events-none" />
    </button>
  );
}
    ...
    <section className="py-20 lg:py-28 bg-[#0d0b12]">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between gap-4 mb-8 sm:mb-10">
          <div>
            <span className="block font-sans text-[11px] uppercase tracking-[0.25em] text-[#f2a03c] mb-3">
              Client Stories
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-white leading-tight">
              Hear it from <span className="italic text-[#c8a3f0]">our clients</span>
            </h2>
        ...
        >
          ...
          <div className="flex-shrink-0">
            <a href="https://wa.me/919030444503" target="_blank" rel="noopener noreferrer" className="group block">
              <div className="relative w-[155px] sm:w-[175px] lg:w-[195px] aspect-[9/16] rounded-2xl border border-dashed border-white/15 bg-white/[0.015] flex flex-col items-center justify-center text-center p-4 hover:border-[#8b5cd8]/40 hover:bg-[#8b5cd8]/[0.04] transition-all duration-300">
                <div className="w-10 h-10 rounded-full border border-[#8b5cd8]/30 bg-[#8b5cd8]/5 flex items-center justify-center mb-3 group-hover:bg-[#8b5cd8]/20 transition-colors duration-300">
                  <MessageCircle className="w-4 h-4 text-[#c8a3f0]" />
                </div>
                ...
                <span className="font-sans text-[10px] text-[#f2a03c] border border-[#f2a03c]/25 px-2.5 py-1 rounded-full group-hover:bg-[#f2a03c]/10 transition-colors duration-200">WhatsApp us</span>
              </div>
            </a>
          </div>
        </div>

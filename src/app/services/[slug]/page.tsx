      ...
      <main>
        ...
        <section className="relative min-h-[80vh] flex items-end overflow-hidden">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 pb-20 pt-36">
            <div className="max-w-3xl">
              ...
              <span className="block text-[#c674f3] text-xs font-sans font-semibold tracking-[0.28em] uppercase mb-5">
              ...
              <div className="flex flex-wrap gap-4">
                ...
                {stats.warranty && (
                  <div className="flex items-center gap-2 bg-white/10 backdrop-blur-md ring-1 ring-white/15 px-5 py-3 rounded-full">
                    <ShieldCheck className="w-4 h-4 text-[#c674f3]" />
                    <span className="text-white font-sans text-sm font-medium">
                      {stats.warranty}
                    </span>
                  </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              <div className="lg:col-span-7">
                <span className="inline-flex items-center gap-2 text-[#c674f3] text-xs font-sans font-semibold tracking-[0.25em] uppercase mb-5">
                  <span
                    aria-hidden="true"
                    className="w-8 h-px bg-[#c674f3]"
                  />
                  The Overview
                </span>
                ...
                <Link
                  href="/contact"
                  className="inline-flex items-center gap-2 px-8 py-4 bg-[#c674f3] hover:bg-[#9b57cf] text-white font-sans font-medium text-base transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-[#c674f3]/25"
                >
                    ...
                    <ul className="space-y-3.5">
                      {features.map((feature, index) => (
                        <li key={index} className="flex items-start gap-3">
                          <CheckCircle2 className="w-5 h-5 text-[#c674f3] flex-shrink-0 mt-0.5" />
          ...
          <section className="py-20 lg:py-28 bg-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-2xl mx-auto mb-14">
                <span className="text-[#c674f3] text-xs font-sans font-semibold tracking-[0.25em] uppercase">
                  What&apos;s Included
                </span>
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {inclusions.map((item, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="group bg-[#f7f5fb] rounded-2xl p-8 transition-all duration-300 hover:bg-[#1a1720] hover:-translate-y-1 hover:shadow-xl"
                    >
                      <div className="w-12 h-12 rounded-xl bg-[#c674f3]/10 group-hover:bg-[#c674f3] flex items-center justify-center text-[#c674f3] group-hover:text-white transition-colors duration-300 mb-5">
        ...
        <section className="py-20 lg:py-28 bg-[#1a1720]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                return (
                  <div key={index} className="flex gap-5">
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 flex-shrink-0 rounded-full bg-[#c674f3]/15 border border-[#c674f3]/40 flex items-center justify-center text-[#c674f3]">
                        {processIcons[index % processIcons.length]}
                      </div>
                      {!isLast && (
                        <div
                          aria-hidden="true"
                          className="w-px flex-1 bg-gradient-to-b from-[#c674f3]/40 to-[#c674f3]/5 my-1"
                        />
                      )}
                    </div>
                    <div className="pb-10">
                      <div className="flex flex-wrap items-center gap-3 mb-1.5">
                        ...
                        <span className="text-xs font-sans font-semibold text-[#c674f3] bg-[#c674f3]/10 px-2.5 py-0.5 rounded-full border border-[#c674f3]/20">
                          {step.duration}
                        </span>
                      </div>
            ...
            <div className="text-center mt-6">
              <Link
                href="/process"
                className="inline-flex items-center gap-2 text-[#c674f3] font-sans font-medium text-sm hover:underline"
              >
                ...
                <div className="lg:col-span-8">
                  <div className="grid sm:grid-cols-2 gap-px bg-gray-200 rounded-2xl overflow-hidden ring-1 ring-gray-200">
                    {materials.map((material, index) => (
                      <div
                        key={index}
                        className="bg-white p-7 transition-colors duration-300 hover:bg-[#f7f5fb]"
                      >
                        <div className="flex items-center gap-3 mb-2">
                          <span className="w-7 h-7 rounded-full bg-[#c674f3]/10 text-[#c674f3] flex items-center justify-center text-xs font-sans font-bold tabular-nums">
                            {index + 1}
                          </span>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200 rounded-3xl overflow-hidden ring-1 ring-gray-200">
                {whyChoose.map((item, index) => (
                  <div
                    key={index}
                    className="bg-white p-8 transition-colors duration-300 hover:bg-[#f7f5fb]"
                  >
                    <div className="font-serif text-3xl text-[#c674f3]/30 mb-4 tabular-nums">
                      0{index + 1}
                    </div>
        ...
        {testimonial && (
          <section className="py-20 lg:py-32 bg-[#1a1720] relative overflow-hidden">
            <div
              aria-hidden="true"
              className="absolute -top-24 -right-24 w-96 h-96 rounded-full bg-[#c674f3]/10 blur-3xl"
            />
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="max-w-3xl mx-auto text-center">
                <Quote
                  aria-hidden="true"
                  className="w-12 h-12 text-[#c674f3] mx-auto mb-8"
                />
                ...
                <div className="flex flex-col items-center">
                  <div
                    aria-hidden="true"
                    className="w-12 h-px bg-[#c674f3] mb-5"
                  />
                ...
                {relatedServices.map((related) => (
                  ...
                  >
                    ...
                    <div className="p-5 flex items-center justify-between">
                      <div>
                        <p className="text-xs text-[#c674f3] font-sans font-semibold uppercase tracking-wider mb-1">
                      ...
                      <ArrowRight className="w-5 h-5 text-[#c674f3] group-hover:translate-x-1 transition-transform duration-200" />
                    </div>
                  </Link>
                ))}
              </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between gap-4 py-3.5">
            <div className="min-w-0">
              ...
              {content?.tagline && (
                <p className="font-sans text-xs text-[#c674f3] hidden sm:block">
                  {content.tagline}
                </p>
              )}
            </div>
            <Link
              href="/contact"
              className="flex-shrink-0 inline-flex items-center gap-2 px-5 sm:px-7 py-3 bg-[#c674f3] hover:bg-[#9b57cf] text-white font-sans font-medium text-sm transition-colors duration-300 rounded-full"
            >

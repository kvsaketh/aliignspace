...
const SORTABLE_FIELDS = ["updatedAt", "createdAt", "title", "slug", "status"];
...
export async function GET(request: NextRequest) {
  try {
    ...
    const sortBy = SORTABLE_FIELDS.includes(searchParams.get("sortBy") || "")
    ...
    // Unauthenticated callers only ever see published pages
    if (!session) {

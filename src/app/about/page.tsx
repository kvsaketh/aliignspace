...
export default function AboutPage() {
  return (
    <>
      ...
      <main>
        {/* ── 1. HERO ── */}
        <section className="relative min-h-[65vh] flex items-end pb-20 pt-32 bg-[#16141f] overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              priority
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[#16141f] via-[#16141f]/80 to-[#16141f]/30" />
          </div>
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
            <p className="text-[#c674f3] font-sans text-sm uppercase tracking-widest mb-5">
            ...
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl text-white leading-tight mb-6">
              ...
              <em className="text-[#c674f3] not-italic">Tell Your Story</em>
            </h1>
        ...
        <section className="py-24 lg:py-32 bg-[#f7f5fb]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <p className="text-[#c674f3] font-sans text-sm uppercase tracking-widest mb-4">
                  Our Story
                </p>
                <h2 className="font-serif text-4xl sm:text-5xl text-[#16141f] leading-tight mb-8">
                  Built on a single belief
                </h2>
                <p className="font-sans text-[#16141f]/70 text-base leading-relaxed mb-5">
                ...
                <p className="font-sans text-[#16141f]/70 text-base leading-relaxed mb-10">
                ...
                <blockquote className="bg-[#16141f] text-white p-6 rounded-lg">
        ...
        {/* ── 3. STATS BAR ── */}
        <section className="bg-[#16141f] py-14">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-10 text-center">
              {[
                ...
                <div key={label}>
                  <p className="font-serif text-4xl sm:text-5xl text-[#c674f3] mb-2">
                    {number}
                  </p>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-[#f7f5fb] p-10 rounded-2xl">
                <div className="w-12 h-12 bg-[#c674f3]/10 border border-[#c674f3]/20 rounded-full flex items-center justify-center mb-6">
                  <span className="font-serif text-[#c674f3] text-xl font-bold">
                    M
                  </span>
                </div>
                <h3 className="font-serif text-2xl text-[#16141f] mb-4">
                  Our Mission
                </h3>
                <p className="font-sans text-[#16141f]/70 text-base leading-relaxed">
              ...
              <div className="bg-[#16141f] p-10 rounded-2xl">
            ...
            <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
              {[
                ...
                <div key={name} className="bg-white p-8 rounded-2xl shadow-sm">
                  <div className="w-20 h-20 bg-[#c674f3]/10 border border-[#c674f3]/20 rounded-full flex items-center justify-center mb-6">
                    <span className="font-serif text-[#c674f3] text-xl font-semibold">
                      {initials}
                    </span>
                  </div>
                  <h3 className="font-serif text-xl text-[#16141f] mb-1">
                    {name}
                  </h3>
                  <p className="font-sans text-[#c674f3] text-xs uppercase tracking-widest mb-4">
                    {role}
                  </p>
                  <p className="font-sans text-[#16141f]/70 text-sm leading-relaxed">
                    {bio}
                  </p>
                </div>
              ))}
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={num} className="bg-[#f7f5fb] p-6 rounded-xl">
                  <p className="font-sans text-[#c674f3] text-xs font-semibold tracking-widest mb-3">
                    {num}
                  </p>
                  <h3 className="font-serif text-lg text-[#16141f] mb-2">
                    {title}
                  </h3>
        ...
        {/* ── 7. TIMELINE ── */}
        <section className="py-24 bg-[#16141f]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
                ...
                {[
                  ...
                  <div key={year} className="relative text-center lg:text-left">
                    <div className="hidden lg:flex justify-center mb-6">
                      <div className="w-4 h-4 rounded-full bg-[#c674f3] ring-4 ring-[#c674f3]/20 relative z-10" />
                    </div>
                    <p className="font-serif text-4xl text-[#c674f3] mb-2">
                      {year}
                    </p>
        ...
        {/* ── 8. CTA ── */}
        <section className="py-24 bg-[#c674f3]">
          <div className="max-w-3xl mx-auto px-6 lg:px-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-[#c674f3] font-sans font-semibold text-sm tracking-wide hover:bg-white/90 transition-colors"
              >
                Book a Consultation
              </Link>
              <Link

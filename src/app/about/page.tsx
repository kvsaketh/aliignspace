...
export default function AboutPage() {
  return (
    <>
      ...
      <main>
        {/* ── 1. HERO ── */}
        <section className="relative min-h-[65vh] flex items-end pb-20 pt-32 bg-[#1a1720] overflow-hidden">
        ...
        {/* ── 2. STORY ── */}
        <section className="py-24 lg:py-32 bg-[#f6f4fb]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="font-sans text-stone-600 text-base leading-relaxed mb-5">
                ...
                <p className="font-sans text-stone-600 text-base leading-relaxed mb-10">
                ...
                <blockquote className="bg-[#1a1720] text-white p-6 rounded-lg">
        ...
        {/* ── 3. STATS BAR ── */}
        <section className="bg-[#1a1720] py-14">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-[#f6f4fb] p-10 rounded-2xl">
                ...
                <h3 className="font-serif text-2xl text-[#1a1720] mb-4">
                  Our Mission
                </h3>
        ...
        {/* ── 7. TIMELINE ── */}
        <section className="py-24 bg-[#1a1720]">
          <div className="max-w-7xl mx-auto px-6 lg:px-12">

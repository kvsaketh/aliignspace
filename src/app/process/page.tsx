...
export default function ProcessPage() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="relative min-h-[55vh] flex items-end pb-20 overflow-hidden bg-[#1a1720]">
          ...
          <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-medium text-white leading-tight max-w-3xl">
              A process built on{" "}
              <em className="not-italic italic text-[#c674f3]">transparency</em>
            </h1>
        ...
        <section className="bg-[#c674f3] py-6">
        ...
        <section className="py-20 bg-[#1a1720]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="relative max-w-4xl mx-auto">
              {/* Connecting line */}
              <div className="absolute top-8 left-8 right-8 h-px bg-[#c674f3]/30 hidden sm:block" />
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-8">
                {[
                  ...
                  <div key={item.phase} className="relative flex flex-col items-center text-center">
                    <div className="w-16 h-16 rounded-full bg-[#c674f3]/10 border border-[#c674f3]/30 flex items-center justify-center mb-4 relative z-10">
                      <span className="font-serif text-[#c674f3] text-sm font-medium">{i + 1}</span>
                    </div>
                    <span className="font-sans text-xs text-[#c674f3] font-semibold tracking-wider uppercase block mb-1">{item.phase}</span>
            ...
            <div className="space-y-6">
              {faqs.map((faq, i) => (
                <div key={i} className="bg-white p-7 shadow-sm">
                  <h3 className="font-serif text-lg font-medium text-[#1a1720] mb-3">{faq.q}</h3>
        ...
        <section className="py-16 bg-white border-t border-stone-100">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="font-serif text-3xl sm:text-4xl font-medium text-[#1a1720] mb-4">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 bg-[#c674f3] hover:bg-[#9b57cf] text-white font-sans font-semibold px-8 py-4 transition-all duration-300 hover:shadow-lg hover:shadow-[#c674f3]/25 group"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 border border-[#1a1720] text-[#1a1720] font-sans font-medium px-8 py-4 hover:bg-[#1a1720] hover:text-white transition-all duration-300"
              >

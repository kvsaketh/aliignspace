  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 py-24">
            ...
            <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl font-medium text-white leading-tight mb-6">
              ...
              <em className="not-italic text-[#d9a5f7]"> Intention &amp; Heart</em>
            </h1>
        ...
        {/* Stats */}
        <section className="bg-[#16141f] py-10">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {stats.map((stat) => (
                <div key={stat.label}>
                  <p className="font-serif text-4xl font-medium text-[#c674f3] mb-1">{stat.value}</p>
        ...
        <section className="py-20 bg-[#f2f1f8]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="text-[#c674f3] text-xs font-sans font-semibold tracking-[0.25em] uppercase">Your Project</span>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-medium text-[#16141f] mt-4 mb-6">
              Want to see your home here?<br /><em className="not-italic text-[#c674f3]">Let&apos;s talk.</em>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-[#16141f] hover:bg-[#c674f3] text-white font-sans font-medium text-base transition-all duration-300 hover:-translate-y-0.5">
                Get Free Consultation
              </Link>
              <Link href="https://wa.me/919030444503" target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center justify-center px-8 py-4 border border-[#16141f] hover:border-[#c674f3] text-[#16141f] hover:text-[#c674f3] font-sans font-medium text-base transition-all duration-300">
                Chat on WhatsApp
              </Link>
            </div>
          </div>

...
export default async function AliignspaceSeedPage() {
    ...
    <div className="space-y-8">
      ...
      <div>
        <h2 className="text-2xl font-bold tracking-tight">
          Aliignspace Content Seeding
        </h2>
        <p className="text-muted-foreground">
          One-click setup for the Aliignspace website replication
        </p>
      </div>
          ...
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-semibold">
                Seed All Aliignspace Content
              </h3>
              <p className="text-muted-foreground max-w-lg">
                This action will create or update all Aliignspace pages, services,

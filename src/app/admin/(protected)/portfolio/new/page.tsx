...
import { ArrowLeft, Plus, X, Youtube, Image as ImageIcon } from "lucide-react";
    ...
    <div className="max-w-3xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="title" value={title} onChange={(e) => setTitle(e.target.value)} placeholder="e.g. Stunning 3BHK — Urban Trilla, Mokila" required />
            </div>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="location" value={location} onChange={(e) => setLocation(e.target.value)} placeholder="e.g. Jubilee Hills, Hyderabad" />
              </div>
            </div>
            <div className="space-y-1.5">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">Thumbnail auto-fills as cover image when pasted.</p>
            </div>
            <div className="space-y-1.5">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1.5">
              ...
              <Input id="cover" value={coverImage} onChange={(e) => setCoverImage(e.target.value)}
                placeholder="https://... (auto-filled from YouTube)" />
              {coverImage && (
        ...
        <div className="flex gap-3 pb-10">
          <Button type="submit" disabled={saving} className="bg-terracotta-500 hover:bg-terracotta-600">{saving ? "Saving..." : "Create Project"}</Button>
